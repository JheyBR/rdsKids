              ...
              <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12">
                <div className="mb-12 max-w-[360px] lg:mb-16 flex flex-col items-center text-center">
                  ...
                  <p className="mb-9 text-sm text-base leading-relaxed text-body-color dark:text-body-color-dark">
                     Enseñamos programación a niños y jóvenes para que creen tecnología, 
  desarrollen pensamiento lógico y construyan el futuro.
                  </p>
                  <div className="flex items-center">
                    ...
                    <a
                      href="https://www.linkedin.com/company/103873779"
                      aria-label="social-link"
                      target="_blank"
                      rel="noopener noreferrer"
