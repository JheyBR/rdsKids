              ...
              {SOCIAL_LINKS.filter(s => s.name === "whatsapp").map((social) => (
                <a
                  ...
                  className="flex items-center justify-center w-14 h-14 rounded-full bg-green-500 
                            ...
                            hover:w-48 hover:px-4 hover:justify-start group-hover:justify-start"
                  title="Contáctanos por WhatsApp"
                >
                  {/* FontAwesome Icon */}
                  <svg className="w-6 h-6 fill-current text-white flex-shrink-0" viewBox="0 0 448 512">
                  ...
                  <span className="ml-2 text-sm font-semibold text-white whitespace-nowrap 
                                  opacity-0 w-0 overflow-hidden transition-all duration-300 
